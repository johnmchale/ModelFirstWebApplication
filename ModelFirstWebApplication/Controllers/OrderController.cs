...
namespace ModelFirstWebApplication.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            var repositoryContext = _context.Order.Include(o => o.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,Date,OrderState,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
